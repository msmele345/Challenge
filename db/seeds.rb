...
character2  = {:name => "Winnie",
  :level => 14, 
  :primary_attr => "Vitality",
  :avatar_url => "http://rpgcodex.net/phpBB/images/avatars/gallery/Armageddon%20Empires/EOM13.jpg",
  :user_id => 1,
  :fighter_class_id => 1
}
